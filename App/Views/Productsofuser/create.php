...
<form action="create" class="form-signin" method="post">
    ...
    <input type="text" name="inputUserId" class="form-control" placeholder="User id" required="" autofocus="">
    </label>
    <label for="inputProductId" class="sr-only">Product id</label>
    <input type="text" name="inputProductId" class="form-control" placeholder="Product id" required="">
    </label>
